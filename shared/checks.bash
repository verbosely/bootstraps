...
check_params() {
    ...
    while true; do
        case "$1" in
            ...
            '-i'|'--install'|'-P'|'--purge-all-except'|\
                    '-r'|'--replace-all-with')
                _check_param_args "$1" "$2"
                shift 2;;
            '--')
                shift ; break;;
        esac ; _check_conflicting_params
    ...
    unset -f _check_conflicting_params _check_param_args check_params
}
